    ...
    <Header/>
     ...
     <div className="">
        <form className="max-w-2xl  mx-auto bg-white p-8 rounded-lg shadow-md">
         ...
         <button className="bg-purple-600 mt-6 sm:ml-60 ml-20 text-white px-10 py-3 rounded-md font-medium transition-all duration-300 hover:bg-purple-700 hover:-translate-y-1 hover:shadow-md inline-flex items-center gap-2">Submit</button>
        </form>
        </div>
     </div>
