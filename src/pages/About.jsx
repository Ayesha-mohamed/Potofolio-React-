...
function About() {
    ...
    <div className="mt-10 ml-10 ">
        ...
        <img className=" mt-6 border-2 border-purple-800 ml-4 rounded-[50%] shadow-[0 10px 20px rgb(0,0,0,0.1) ] object-cover w-[250px] h-[250px]" src= "https://i.pinimg.com/736x/d6/1e/2c/d61e2ce8304f79611f8648f5bc01791a.jpg" alt="" />
           ...
           <h2 class="text-2xl font-bold mb-8 ml-8">My Skills</h2>
<div class="flex flex-wrap gap-8 mt-8">
    <div class="flex-1 min-w-[250px] ml-3">
        <h3 class="text-xl font-semibold">Web Development</h3>
        <div class="flex flex-wrap gap-3 mt-4">
            <span class="bg-purple-600 text-white px-3 py-1 rounded-full text-sm">HTML</span>
            <span class="bg-purple-600 text-white px-3 py-1 rounded-full text-sm">CSS</span>
            <span class="bg-[#9b88c9] text-white px-3 py-1 rounded-full text-sm opacity-80">JavaScript</span>
            <span class="bg-purple-600 text-white px-3 py-1 rounded-full text-sm">Git/GitHub</span>
            <span class="bg-purple-600 text-white px-3 py-1 rounded-full text-sm">Responsive Design</span>
        </div>
    </div>
    <div class="flex-1 min-w-[250px]">
        <h3 class="text-xl font-semibold">Statistics & Planning</h3>
        <div class="flex flex-wrap gap-3 mt-4">
            <span class="bg-purple-600 text-white px-3 py-1 rounded-full text-sm">Data Analysis</span>
            <span class="bg-purple-600 text-white px-3 py-1 rounded-full text-sm">Statistical Modeling</span>
            <span class="bg-purple-600 text-white px-3 py-1 rounded-full text-sm">Economic Planning</span>
            <span class="bg-purple-600 text-white px-3 py-1 rounded-full text-sm">Research Methods</span>
        </div>
    </div>
    <div class="flex-1 min-w-[250px]">
        <h3 class="text-xl font-semibold">Emerging Skills</h3>
        <div class="flex flex-wrap gap-3 mt-4">
            <span class="bg-[#9b88c9] text-white px-3 py-1 rounded-full text-sm opacity-80">Graphic Design</span>
            <span class="bg-[#9b88c9] text-white px-3 py-1 rounded-full text-sm opacity-80">UI/UX Principles</span>
        </div>
    </div>
</div>

    <h2 class="text-2xl font-bold mb-8 mt-5 ml-6">My Projects</h2>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 ease-in-out border border-gray-200 hover:-translate-y-2">
            ...
            <div class="p-6">
                <h3 class="text-xl font-semibold text-purple-600 mb-2">My First Web Project</h3>
                <p class="text-gray-600 mb-4">My initial exploration into web development, showcasing basic HTML and CSS skills as I began my coding journey.</p>
